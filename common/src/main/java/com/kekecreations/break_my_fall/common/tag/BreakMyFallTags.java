package com.kekecreations.break_my_fall.common.tag;
...
public class BreakMyFallTags {
    ...
    public static class BlockTags {
        ...
        private static TagKey<Block> tag(String name) {
            return TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(BreakMyFall.MOD_ID, name));
        }
    ...
    public static class FluidTags {
        ...
        private static TagKey<Fluid> tag(String name) {
            return TagKey.create(Registries.FLUID, ResourceLocation.fromNamespaceAndPath(BreakMyFall.MOD_ID, name));
        }
