package com.kekecreations.break_my_fall.core.tags;
...
public class BreakMyFallTags {
    ...
    public static class BlockTags {
        ...
        private static TagKey<Block> tag(String name) {
            return TagKey.create(Registries.BLOCK, new ResourceLocation(BreakMyFall.MOD_ID, name));
        }

        public static void registerBlockTags() {
            System.out.println("Break My Fall Block Tags Loaded");
        }
    }
    ...
    public static class FluidTags {
        ...
        private static TagKey<Fluid> tag(String name) {
            return TagKey.create(Registries.FLUID, new ResourceLocation(BreakMyFall.MOD_ID, name));
        }
        public static void registerFluidTags() {
            System.out.println("Break My Fall Fluid Tags Loaded");
        }
    }
}
