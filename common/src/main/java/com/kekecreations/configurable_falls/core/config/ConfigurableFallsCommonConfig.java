package com.kekecreations.configurable_falls.core.config;

import net.neoforged.neoforge.common.ModConfigSpec;

public class ConfigurableFallsCommonConfig {

    public static final ModConfigSpec.Builder BUILDER = new ModConfigSpec.Builder();
    public static final ModConfigSpec SPEC;

    public static final ModConfigSpec.ConfigValue<Double> WATER_FALL_DAMAGE_FALL_DISTANCE;
    public static final ModConfigSpec.ConfigValue<Double> WATER_DEPTH_1_FALL_DAMAGE_PERCENTAGE;

    public static final ModConfigSpec.ConfigValue<Double> WATER_DEPTH_2_FALL_DAMAGE_PERCENTAGE;

    public static final ModConfigSpec.ConfigValue<Double> WATER_DEPTH_3_FALL_DAMAGE_PERCENTAGE;

    public static final ModConfigSpec.ConfigValue<Double> WATER_DEPTH_4_FALL_DAMAGE_PERCENTAGE;

    public static final ModConfigSpec.ConfigValue<Double> WATER_DEPTH_5_FALL_DAMAGE_PERCENTAGE;

    public static final ModConfigSpec.ConfigValue<Boolean> ICE_BREAK_ON_FALL;
    public static final ModConfigSpec.ConfigValue<Double> ICE_BREAK_ON_FALL_FALL_DISTANCE;

    public static final ModConfigSpec.ConfigValue<Boolean> SUS_BLOCKS_BREAK_ON_FALL;
    public static final ModConfigSpec.ConfigValue<Double> SUS_BLOCKS_BREAK_ON_FALL_FALL_DISTANCE;

    public static final ModConfigSpec.ConfigValue<Boolean> MELON_EXPLODE_INTO_SLICES_ON_FALL;
    public static final ModConfigSpec.ConfigValue<Double> MELON_EXPLODE_INTO_SLICES_ON_FALL_FALL_DISTANCE;

    public static final ModConfigSpec.ConfigValue<Boolean> GLASS_BREAK_ON_FALL;
    public static final ModConfigSpec.ConfigValue<Double> GLASS_BREAK_ON_FALL_FALL_DISTANCE;
    public static final ModConfigSpec.ConfigValue<Boolean> GLASS_BREAK_ON_FALL_DROPS;
    public static final ModConfigSpec.ConfigValue<Boolean> GLASS_PANE_BREAK_ON_FALL;
    public static final ModConfigSpec.ConfigValue<Double> GLASS_PANE_BREAK_ON_FALL_FALL_DISTANCE;

    public static final ModConfigSpec.ConfigValue<Boolean> SNOW_BREAK_ON_FALL;
    public static final ModConfigSpec.ConfigValue<Boolean> SNOW_BREAK_ON_FALL_DROPS;
    public static final ModConfigSpec.ConfigValue<Double> SNOW_BREAK_ON_FALL_FALL_DISTANCE;

    public static final ModConfigSpec.ConfigValue<Boolean> LEAVES_BREAK_ON_FALL;
    public static final ModConfigSpec.ConfigValue<Boolean> LEAVES_BREAK_ON_FALL_DROPS;
    public static final ModConfigSpec.ConfigValue<Double> LEAVES_BREAK_ON_FALL_FALL_DISTANCE;

    public static final ModConfigSpec.ConfigValue<Boolean> GRASS_BREAK_ON_FALL;
    public static final ModConfigSpec.ConfigValue<Boolean> GRASS_BREAK_ON_FALL_DROPS;
    public static final ModConfigSpec.ConfigValue<Double> GRASS_BREAK_ON_FALL_FALL_DISTANCE;
    public static final ModConfigSpec.ConfigValue<Boolean> GRASS_TURNS_TO_DIRT_ON_FALL;
    public static final ModConfigSpec.ConfigValue<Double> GRASS_TURNS_TO_DIRT_ON_FALL_FALL_DISTANCE;
    public static final ModConfigSpec.ConfigValue<Boolean> TALL_GRASS_BREAK_ON_FALL;
    public static final ModConfigSpec.ConfigValue<Boolean> TALL_GRASS_BREAK_ON_FALL_DROPS;
    public static final ModConfigSpec.ConfigValue<Double> TALL_GRASS_BREAK_ON_FALL_FALL_DISTANCE;
    public static final ModConfigSpec.ConfigValue<Double> HAY_BALE_FALL_DAMAGE_PERCENTAGE;

    public static final ModConfigSpec.ConfigValue<Boolean> CONFIGURABLE_FALLS_FRAGILE_BREAK_ON_FALL_DROPS;
    public static final ModConfigSpec.ConfigValue<Double> CONFIGURABLE_FALLS_FRAGILE_BREAK_ON_FALL_FALL_DISTANCE;

    public static final ModConfigSpec.ConfigValue<Boolean> SMALL_FLOWERS_BREAK_ON_FALL;
    public static final ModConfigSpec.ConfigValue<Boolean> SMALL_FLOWERS_BREAK_ON_FALL_DROPS;
    public static final ModConfigSpec.ConfigValue<Double> SMALL_FLOWERS_BREAK_ON_FALL_FALL_DISTANCE;

    public static final ModConfigSpec.ConfigValue<Boolean> TALL_FLOWERS_BREAK_ON_FALL;
