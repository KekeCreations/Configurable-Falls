...
public class ConfigurableFallsFabricTags {
    ...
    private static TagKey<Block> tag(String name) {
        return BlockTags.create(String.valueOf(new ResourceLocation(ConfigurableFalls.MOD_ID, name)));
    }
    private static TagKey<Fluid> fluidTag(String name) {
        return FluidTags.create(String.valueOf(new ResourceLocation(ConfigurableFalls.MOD_ID, name)));
    }
}
