package com.kekecreations.break_my_fall.core.event;
...
@EventBusSubscriber(modid = BreakMyFall.MOD_ID)
public class KekeFallEvent {
    ...
    public static void onFall(LivingFallEvent livingFallEvent) {
        ...
        if (!entity.level().isClientSide()) {
            ...
            //Glass
            if (entity.fallDistance >= BreakMyFallCommonConfig.GLASS_BREAK_ON_FALL_FALL_DISTANCE.get() && BreakMyFallCommonConfig.GLASS_BREAK_ON_FALL.get() && entity.level().getBlockState(blockPos).is(Tags.Blocks.GLASS_BLOCKS)) {
            ...
            if (entity.fallDistance >= BreakMyFallCommonConfig.TALL_FLOWERS_BREAK_ON_FALL_FALL_DISTANCE.get() && BreakMyFallCommonConfig.TALL_FLOWERS_BREAK_ON_FALL.get() && entity.level().getBlockState(layerPos).is(BreakMyFallTags.BlockTags.TALL_FLOWERS)) {
