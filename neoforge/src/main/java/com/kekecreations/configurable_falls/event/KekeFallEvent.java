package com.kekecreations.configurable_falls.event;
...
@EventBusSubscriber(modid = ConfigurableFalls.MOD_ID)
public class KekeFallEvent {
    ...
    public static void onFall(LivingFallEvent livingFallEvent) {
        ...
        if (!entity.level().isClientSide()) {
            ...
            //Glass
            if (entity.fallDistance >= ConfigurableFallsCommonConfig.GLASS_BREAK_ON_FALL_FALL_DISTANCE.get() && ConfigurableFallsCommonConfig.GLASS_BREAK_ON_FALL.get() && entity.level().getBlockState(blockPos).is(Tags.Blocks.GLASS_BLOCKS)) {
